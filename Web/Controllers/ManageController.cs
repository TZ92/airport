...
namespace Web.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var Iduser = User.Identity.GetUserId<int>();
            var model = new IndexViewModel
            {
                HasPassword = HasPassword(),
                PhoneNumber = await UserManager.GetPhoneNumberAsync(Iduser),
                TwoFactor = await UserManager.GetTwoFactorEnabledAsync(Iduser),
                Logins = await UserManager.GetLoginsAsync(Iduser),
